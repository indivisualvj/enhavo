                ...
                <div class="result-search">
                    ...
                    <div v-if="!mediaLibrary.data.loading">
                        <div class="media-library-view-switch">
                            <i class="icon icon-account_box" :class="getView() === 'thumbnail' && 'active'" @click="setView('thumbnail')"></i>
                            <i class="icon icon-format_list_bulleted" :class="getView() === 'list' && 'active'" @click="setView('list')"></i>
                        </div>
...
export default class extends Vue {
    ...
    getView(type: string) {
        return this.mediaLibrary.getView();
    }
